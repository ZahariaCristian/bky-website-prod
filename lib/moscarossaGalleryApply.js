...
function needsMoscarossaBulkGallerySync(panel, selectedImages) {
    // A bulk edit is an explicit request to reconcile the remote ad. Matching
    // local IDs cannot tell us whether an earlier remote upload succeeded.
    return panel === "moscarossa" && selectedImages.length > 0;
}
