...
async function loadAdvertisement (res) {
    ...
    if (res.storagePics) {
        ...
        res.images.forEach((img) => {
            addImage(img.src, img.id, img.isHidden);
        });
    };
...
const postsPanelOperations = (panel) => {
    panel.querySelector(".btn-primary").addEventListener("click", () => {
        ...
        btnPremium.classList.add("btnPremiumCam");
        ...
        btnCam.classList.add("btnPremiumCam");
...
const togglePremiumCam = (btn, premium) =>{
...
// IMAGE UPLOAD
function addImage(imgUrl, idDB, isHidden) {
...
function requestUpdate(reload){
    ...
    fetch("/annuncio/updateSchedule", {
        ...
        document.querySelector("#updateScheduleBtn").setAttribute("disabled", true);
        //alert("📅 Pubblicazioni aggiornate correttamente.");
