...
const addImage = (imgUrl, idDB, isHidden, applyPhone, origin) => {
    ...
    leftButton.setAttribute("class", "btn btn-success img-move-btn");
    leftButton.innerHTML = `<i class="fa fa-arrow-left"></i>`;

    const rightButton = document.createElement("button");
    rightButton.setAttribute("class", "btn btn-success img-move-btn");
...
async function movePicLeft(picId) {
    ...
    if (picPosition > -1) {
        ...
        if (typeof enablePicsUpdate === "function") enablePicsUpdate();
    }
